...
```text
Initialize the RecoWork template [idea-engineering | learning-engineering | project-engineering | web-design-standard] for the [local-agent-project] environment in [zh | en] at [destination].
