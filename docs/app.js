...
rw add project --target codex-project --locale zh .`,
    ...
    learningDesc:
      "先诊断并确认学习约定，再推进课程路线、章节练习、项目实践、反馈、复盘和知识沉淀。",
...
rw add project --target codex-project --locale en .`,
    ...
    learningDesc:
      "Starts with diagnosis and a confirmed learning agreement, then advances through roadmaps, lessons, practice, projects, feedback, retrospectives, and durable knowledge capture.",
